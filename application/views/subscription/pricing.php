...
<head>
    ...
    <style>
        body {
            ...
            background: linear-gradient(135deg, #e6f2f8 0%, #f0f4f8 100%);
            min-height: 100vh;
            padding: 40px 20px;
        }
        ...
        .pricing-card.essential {
            background: linear-gradient(135deg, #cfe5f2 0%, #b8d9ed 100%);
            border-color: #1C6494;
        }

        .pricing-card.growth {
            background: linear-gradient(135deg, #e4d9f5 0%, #d4c5ed 100%);
        }

        .pricing-card.elite {
            background: linear-gradient(135deg, #fff4d9 0%, #ffe8b8 100%);
        }
